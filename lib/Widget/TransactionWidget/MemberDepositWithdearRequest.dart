              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text('Normal Window', style: TextStyle(
                      fontSize: 8,
                    ),),
                    SizedBox(width: 10),
                    Radio(
                    ...
                    Text('Close Window',style: TextStyle(
                      fontSize: 8,
                    ),),
                  ],
                ),
            ...
            child: Row(
              ...
              children: [
                ...
                widget.submit? Container(
                  ...
                  width: 50,
                  child: Padding(
                    padding: EdgeInsets.only(top: 10.0, left: ScreenWidth/102.4),
                ...
                Container(
                  ...
                  width: 60,
                  child: Padding(
                    padding: EdgeInsets.only(top: 3.0, left: ScreenWidth/102.4),
                    child: Row(
                      children: [
                        Icon(Icons.clear_all_sharp, color: Colors.white, size: 14,),
                        SizedBox(width: 5,),
                ...
                Container(
                  ...
                  width: 20,
                  child: Padding(
                    padding: EdgeInsets.only(top: 10.0, left: ScreenWidth/74.8),
