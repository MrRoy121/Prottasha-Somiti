...
class SlipReprintWidget extends StatefulWidget {


  @override
  State<SlipReprintWidget> createState() => _SlipReprintWidgetState();
}

class _SlipReprintWidgetState extends State<SlipReprintWidget> {
