class loanSanction {
  String somiteename,
      ...
      grantorsmobile,
      grantorpname,
      grantorpfname,requestedby, approvedby,
      grantorprelation,
      grantorpocupasion,
      grantorpmobile;
  ...
  loanSanction(
      ...
      required this.grantorsmobile,required this.requestedby, required this.approvedby,
  ...
  factory loanSanction.fromJson(Map<String, dynamic> json) {
    return loanSanction(
        ...
        remarks: json["Remarks"],approvedby: json["Approved By"],requestedby: json["Requested By"],
