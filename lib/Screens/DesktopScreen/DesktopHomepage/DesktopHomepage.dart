...
class DesktopHomePage extends StatefulWidget {
  ...
  DesktopHomePage({required this.navbool,});
                              ...
                              Row(
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      children: [
                                        Icon(Icons.calendar_today_rounded, color: Colors.white, size: 10,),
                                        SizedBox(width: 5,),
                                        Text(
                                          "All Notice",
                                          style: TextStyle(
                      ...
                      child: Column(
                        children: [
                          Container(
                            ...
                            child: Row(
                              children: [
                                SizedBox(width: ScreenWidth/15.6,),
